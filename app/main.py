...
from app.routers import auth, superadmin, gastos, proveedores, servicios, usuarios, ordenes, b2b, app_users, settings, reportes, suscripcion, configuracion, wompi, join_requests, canales
...
app.include_router(canales.router, prefix="/api", tags=["Canales de Pago"], dependencies=_sub)
